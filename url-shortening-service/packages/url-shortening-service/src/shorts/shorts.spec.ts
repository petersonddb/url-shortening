...
describe("create short use case", () => {
    ...
    describe("given NOT valid short params", () => {
        const userId = "";

        const run =
            () => createShort({originalUrl, userId}, keyService as KeyService, shortService);
    ...
    describe("given valid short params", () => {
        const userId = "test-user-id";

        const run =
            async () => await createShort({originalUrl, userId}, keyService as KeyService, shortService);
